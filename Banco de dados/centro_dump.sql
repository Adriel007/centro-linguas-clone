...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:s/THDZWqEJSVeccQY9aJWQ==$unIMjpYjvqvpOF8ncO+0M7Spj//Pqhmj12DHrqzbCpM=:mTXp9LmHXBAVbTxHMw3i98GpqQMz78/jdrbl0EYi06E=';
...
--
-- Name: dbcentrolinguas; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE dbcentrolinguas WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE dbcentrolinguas OWNER TO postgres;

\connect dbcentrolinguas
...
COPY public.tb_arquivos (id, nome, tamanho, tipo, data_upload, usuario_id) FROM stdin;
\.
...
--
-- Name: tb_arquivos fk_usuario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_arquivos
    ADD CONSTRAINT fk_usuario FOREIGN KEY (usuario_id) REFERENCES public.tb_usuario(id_usuario);
