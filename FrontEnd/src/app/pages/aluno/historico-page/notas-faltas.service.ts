...
export class NotasFaltasService {
  ...
  getNotasFaltas(): NotaFalta[] {
    ...
    return [
      { curso: 'Inglês', nota1: 90, nota2: 85, media: (90 + 85) / 2, faltas: 2 },
      { curso: 'Espanhol', nota1: 80, nota2: 75, media: (80 + 75) / 2, faltas: 3 },
      { curso: 'Francês', nota1: 78, nota2: 82, media: (78 + 82) / 2, faltas: 1 }
    ];
  }
}
